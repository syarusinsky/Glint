...
const unsigned int GLINT_REVERBNET_SD_LEN     = 2719;
const unsigned int GLINT_REVERBNET_SMD_LEN    = ( ABUFFER_SIZE * 12 ) - 1; // TODO not yet in the faust demo, -1 so there's no need to wrap around buffer
#else                                                 // values for 48000kHz sample rate
